// src/components/features/automations/statistics/StatusDistributionChart.tsx
'use client'
    ...
    >
      <Card className="h-full relative overflow-hidden border border-white/10 bg-white/5 dark:bg-black/20 backdrop-blur-md hover:bg-white/10 dark:hover:bg-black/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/20 group">
        ...
        <CardHeader className="pb-2 relative z-10">
          <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-foreground transition-colors">Status Distribution</CardTitle>
        </CardHeader>
